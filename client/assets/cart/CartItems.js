...
import  Button, TextField, Typography, Divider, Card, { CardContent, CardMedia, withStyles } from "material-ui";
...
class CartItems extends Component {
  ...
  render() {
    ...
    return (<Card className={classes.card}>
      ...
      <Typography type="subheading" component="h3" color="primary">There are no items in your cart.</Typography>
    }
    </Card>)
  }
}
